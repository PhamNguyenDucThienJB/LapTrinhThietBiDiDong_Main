...
//
    ...
    public void onClick(View view) {
        ...
        if (id == R.id.btndangKy) btnDangKy();

    }

    public void btnDangKy() {
        Intent iTrangChu1 = new Intent(getApplicationContext(), DangKyActivity.class); // chuyển đổi 2 activity
        startActivity(iTrangChu1);
        finish();
    }
    private void init(){
        Intent iHome = new Intent(getApplicationContext(), DangKyActivity.class);
        startActivity(iHome);
        finish();
    }
}
